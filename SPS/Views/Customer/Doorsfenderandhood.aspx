<%@ Page Title="" Language="C#" MasterPageFile="~/HeaderAndFooter.Master" AutoEventWireup="true" CodeBehind="Doorsfenderandhood.aspx.cs" Inherits="SPS.Views.Customer.Doorsfenderandhood" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SPS %>" SelectCommand="SELECT [Name], [Price], [Image], [ProductID],[CompanyName],[CarName],[CategoryProduct] FROM [Product] WHERE ([CategoryProduct] = '3')">
    </asp:SqlDataSource>
</asp:Content>
