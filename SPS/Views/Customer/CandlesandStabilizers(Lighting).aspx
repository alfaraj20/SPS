<%@ Page Title="" Language="C#" MasterPageFile="~/HeaderAndFooter.Master" AutoEventWireup="true" CodeBehind="CandlesandStabilizers(Lighting).aspx.cs" Inherits="SPS.Views.Customer.CandlesandStabilizers_Lighting_" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SPS %>" SelectCommand="SELECT [Name], [Price], [Image], [ProductID],[CompanyName],[CarName],[CategoryProduct] FROM [Product] WHERE ([CategoryProduct] = '5')">
    </asp:SqlDataSource>
</asp:Content>
