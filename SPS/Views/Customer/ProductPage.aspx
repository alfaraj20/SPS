<%@ Page Title="Products" Language="C#" MasterPageFile="~/HeaderAndFooter.Master" AutoEventWireup="true" CodeBehind="ProductPage.aspx.cs" Inherits="SPS.Views.Customer.ProductPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SPS %>" SelectCommand="SELECT [Name], [Price], [Image], [ProductID],[CompanyName],[CarName] FROM [Product] WHERE ([WorkShopID] = @WorkShopID)">
        <SelectParameters>
            <asp:QueryStringParameter Name="WorkShopID" QueryStringField="wid" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
</asp:Content>
