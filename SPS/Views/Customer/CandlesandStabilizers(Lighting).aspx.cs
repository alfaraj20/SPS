...
{
    public partial class CandlesandStabilizers_Lighting_ : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (IsPostBack)
            {
                ...
                SqlDataAdapter sdaa = new SqlDataAdapter("Select * from Product where Name like '%" + search.Text + "%'and CategoryProduct = '5' ORDER BY CategoryProduct DESC", con);
