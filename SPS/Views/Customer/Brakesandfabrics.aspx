<%@ Page Title="" Language="C#" MasterPageFile="~/HeaderAndFooter.Master" AutoEventWireup="true" CodeBehind="Brakesandfabrics.aspx.cs" Inherits="SPS.Views.Customer.Brakesandfabrics" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SPS %>" SelectCommand="SELECT [Name], [Price], [Image], [ProductID],[CompanyName],[CarName],[CategoryProduct] FROM [Product] WHERE ([CategoryProduct] = '4')">
    </asp:SqlDataSource>
</asp:Content>
