...
{
    public partial class Brakesandfabrics : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (IsPostBack)
            {
                ...
                SqlDataAdapter sdaa = new SqlDataAdapter("Select * from Product where Name like '%" + search.Text + "%'and CategoryProduct = '4' ORDER BY CategoryProduct DESC", con);
