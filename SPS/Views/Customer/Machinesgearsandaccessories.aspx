<%@ Page Title="" Language="C#" MasterPageFile="~/HeaderAndFooter.Master" AutoEventWireup="true" CodeBehind="Machinesgearsandaccessories.aspx.cs" Inherits="SPS.Views.Customer.Machinesgearsandaccessories" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:DataList ID="DataList1" runat="server" Height="293px" Width="310px" RepeatColumns="5" RepeatDirection="Horizontal" Style="border-collapse: collapse;position: absolute;left: 85px;top: 160px;">
        <ItemTemplate>
            <table>
